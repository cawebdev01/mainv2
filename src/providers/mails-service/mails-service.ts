...
export class MailsService {
  ...
  getMails(){
    return this.http.get('http://www1.dc.xandmail.com/ca/testbuild_leggera/cgi-bin/ajaxmail?Act_Msgs_Refresh=1&Tpl=mail_list&ID=IeBAJD5g6ZMmjckWMmBAL37cOyd758_3Psx_tlHtwr2eaFzpU_PA-&CONTID=&C_Folder=SU5CT1g=&autoRefresh=false&KEEPPAGE=1&nocache=619572.7912315703').map((res:Response) => res.json());
